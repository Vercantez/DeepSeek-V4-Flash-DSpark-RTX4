...
: "${BACKEND_PORT:=8000}"
: "${TTFT_TIMEOUT:=60}"
: "${MAX_ADMITTED_REQUEST_BYTES:=2097152}"
...
: "${MODEL_MAX_CONTEXT_TOKENS:=524288}"
: "${MODEL_WORKING_CONTEXT_TOKENS:=524288}"
: "${MODEL_MAX_OUTPUT_TOKENS:=524288}"
...
MAX_ADMITTED_REQUEST_BYTES=$MAX_ADMITTED_REQUEST_BYTES
